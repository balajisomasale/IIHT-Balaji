package com.cognizant.IIHT.UserMicroservice.Security;
...
//	AppVendorDetailsService appVendorDetailsService;
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.cors();
		httpSecurity.csrf().disable().httpBasic().and().authorizeRequests().antMatchers("/users").permitAll().antMatchers("/skills").permitAll().antMatchers("/mentor").permitAll();
